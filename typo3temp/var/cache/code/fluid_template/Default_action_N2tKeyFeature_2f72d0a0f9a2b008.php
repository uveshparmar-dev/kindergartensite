<?php
class Default_action_N2tKeyFeature_2f72d0a0f9a2b008 extends \TYPO3Fluid\Fluid\Core\Compiler\AbstractCompiledTemplate {
...
$output3 .= call_user_func_array( function ($var) { return (is_string($var) || (is_object($var) && method_exists($var, '__toString')) ? htmlspecialchars((string) $var, ENT_QUOTES) : $var); }, [$renderingContext->getVariableProvider()->getByPath('item.data.link')]);

$output3 .= '" class="categories-item">
...
return $renderingContext->getVariableProvider()->getByPath('item.data.bgcolor');
};
...
'width' => 60,
'height' => 60,
'alt' => $renderingContext->getVariableProvider()->getByPath('item.data.header'),
];
...
$output14 .= call_user_func_array( function ($var) { return (is_string($var) || (is_object($var) && method_exists($var, '__toString')) ? htmlspecialchars((string) $var, ENT_QUOTES) : $var); }, [$renderingContext->getVariableProvider()->getByPath('item.data.header')]);
